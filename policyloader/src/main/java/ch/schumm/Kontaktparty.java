...
public class Kontaktparty {
    ...
    public static void main(String[] args) {
        BigInteger pi = bi(4).multiply(arccot(bi(5))).subtract(arccot(bi(239))).multiply(bi(4)); 
        StringBuilder sb = new StringBuilder(); 
        for(; !pi.equals(bi(0)); pi = pi.shiftRight(5)){
            sb.append((char) (pi.and(bi(31)).intValue() % 26 + 65));    
        }
        System.out.println("9. 3. ETH Kontaktparty..."); 
        System.out.println("codewort: " + sb.toString().substring(582, 588)) ; 
    }
